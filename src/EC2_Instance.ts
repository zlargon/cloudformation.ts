...
interface AssociationParameter {
  Key: string;
  Value: string[];
}
...
interface ElasticInferenceAccelerator {
  Count?: number;
  Type: 'eia1.medium' | 'eia1.large' | 'eia1.xlarge' | 'eia2.medium' | 'eia2.large' | 'eia2.xlarge';
}
...
// https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-instance-nodevice.html
interface NoDevice {}

// https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-instance-privatednsnameoptions.html
interface PrivateDnsNameOptions {
